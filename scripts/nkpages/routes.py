...
ROUTES = [
    ...
    *[_town(s) for s in SLUGS],
    ...
    Route("/map/3d/", "map3d", "15068 in 3D" + BRAND, "The ZIP's hills, river and buildings in 3D.",
    ...
    Route("/directory/", "directory", "Places and streets A to Z" + BRAND,
          "Every place and street in the NK15068 map data.",
    ...
    Route("/contact/", "contact", "Contact and corrections" + BRAND,
          "How to reach NK15068 and report a correction.",
